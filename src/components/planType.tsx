...
export const PlanType=({data}:props)=>{
    ...
    return(
        <div onClick={()=>handlePlanClick(name)} className={plan===name? 'cursor-pointer transition-border duration-300 border border-cool-gray border-marine-blue rounded-md p-5 w-[120px] bg-magnolia':'cursor-pointer transition-border duration-300 border border-cool-gray hover:border-marine-blue rounded-md p-5 w-[120px]'}>
